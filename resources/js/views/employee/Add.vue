        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form @submit.prevent="addEmployeeSubmit()" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="date_hired" class="form-control" v-model="employee.date_hired">
                                <span class="help-block m-b-none" v-if="editErrors.date_hired">{{ editErrors.date_hired[0] }}</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
